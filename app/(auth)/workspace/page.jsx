...
setMenu(selected)
  ...
  return (
    <div className=' min-md:flex border-green-500 justify-baseline items-start border-t-2 max-md:flex-col-reverse'>
...
<h4 className='italic px-2 mt-3 font-serif bg-green-200' >For example: "The latest vanilla milkshake flavor blended with milk from a street vendor with the cheapest prices ...."</h4 >
<h4 className='italic font-serif'> Please be as descriptive as possible for the best results :).</h4 >
<form className='flex flex-col justify-center items-center'>

<textarea  placeholder='eg. generate cinemstic videoof the rain...' type='text'autoComplete={"true"} autoCorrect={"true"} maxLength={200}   className=' from-yellow-200 to-green-500 bg-gradient-to-r mt-5 text-green-800 font-semibold rounded-2xl px-5 p-3 w-100 border-2 border-gray-700'></textarea>
...
<div className='flex-col flex '>
  <button onClick={selector}  className=' border-t-2 border-b-2 py-2 animate-right hover:bg-gradient-to-l hover:from-green-200 hover:to-green-100 px-3'>dashboard</button>
...
<button onClick={selector}  className='rounded-br-2xl rounded-bl-2xl border-t-2 border-b-2 py-2 animate-right5 hover:bg-gradient-to-l hover:from-green-800 hover:to-green-700 hover:text-white hover:opacity-50 px-3'>settings</button>
...
<h4 className='italic font-serif mt-2 bg-green-200 p-1' >For example: "The latest vanilla milkshake flavor blended with milk from a street vendor with the cheapest prices ...."</h4 >
<h4 className='italic font-serif'> Please be as descriptive as possible for the best results :).</h4 >
<form className='flex flex-col justify-center items-center'>

<textarea  placeholder='eg. generate cinemstic videoof the rain...' type='text'autoComplete={true} autoCorrect={true} maxLength={200}   className='from-yellow-200 to-green-500 bg-gradient-to-r mt-5 text-green-800 font-semibold rounded-2xl px-5 p-7 w-120 border-2 border-gray-700'></textarea>
  <button onSubmit={{}} className='m-2 w-20 mt-6 border-2 opacity-75 border-green-700 p-2 from-green-600 hover:opacity-88 to-green-300 bg-gradient-to-r rounded-2xl text-green-950'>generate</button>
</form>
  </div>
</div>:<div></div>}
